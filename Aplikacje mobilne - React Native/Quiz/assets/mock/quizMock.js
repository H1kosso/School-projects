const resultsMocks = [
    {
        ...
        tasks: [
            {
                question: "Który wódz po śmierci Gajusza Mariusza, dalej prowadził wojnę domową z Sullą ?",
                answers: [
                    {
            ...
            {
                question: "Pokonany i obarczony główną winą za straszliwą klęskę pod Arauzjoną 105 p.n.e. to:",
                answers: [
                    {
                        content: "KWINTUS CEPION",
                        isCorrect: true
                    },
                    {
                        content: "GAJUSZ WARRON",
                        isCorrect: false
                    },
                    {
                        content: "PUBLIUSZ WARUS",
                        isCorrect: false
                    },
                    {
                        content: "TYTUS FLAMININUS",
                        isCorrect: false
                    }
                ],
                duration: 30
    ...
    {
        id: "61316f7f99149c1a92250e43",
        name: "Zagadki matematyczne",
        description: "Bardzo szybki test sprawdzający podstawową wiedze z matematyki.",
        tags: [
            "matematyka"
        ],
        level: "podstawowy",
