...
figure; freqz(x,1,1000,'whole');           % spektrum DFT signalu x(n) - sygnał wejśćiowy
figure; freqz(xz,1,1000,'whole');          % spektrum DFT signalu xz(n) - sygnał z zerami
figure; freqz(h,1,1000,'whole');           % spektrum DFT filtra h(n) - filtr interpolujący
figure; freqz(yi,1,1000,'whole');          % spektrum DFT signal yi(n) - filtr wygładzający
